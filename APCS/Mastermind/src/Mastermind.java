...
public class Mastermind {
  ...
  private static final int[][] hitCounts = new int[5][5];
  ...
  // took.
  private static int findSecret(int colors, Algo algo, Codeword secret, Codeword.CheckCounter cc,
      PrintStream p)
      throws Exception {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      for (Codeword secret : allCodewords) {
        int turns = findSecret(colors, algo, secret, cc,
